...
[[file:resources/images/babel_lang_dot_example1.png]]
...
:END:
:LOGBOOK:
- Note taken on [2019-02-15 Fri 20:37] \\
  export inline source block has error.
:END:

# src_emacs-lisp{(message "hi")} {{{results(=hi=)}}}

src_python{print("hi")} {{{results(=hi=)}}} 
...
* Blocks
  :PROPERTIES:
  :ID:       07a279b5-4105-45ad-a1b6-99c77b511335
  :PUBDATE:  <2019-08-14 Wed 19:46>
  :END:

** Quote block
   :PROPERTIES:
   :ID:       d0ff3d55-7517-42d9-9981-a0c2fcb0d74a
   :END:
...
** LaTeX export block
   :PROPERTIES:
   :ID:       238bc88c-219c-47ef-be8c-1789b9f83e9f
   :END:
...
** ASCII export block
   :PROPERTIES:
   :ID:       cd71c785-f264-4ef1-9b9c-660d420687a4
   :END:
...
** HTML export block
   :PROPERTIES:
   :ID:       1c841e94-df44-461a-9b11-8d9b1ecb4bd3
   :END:
...
#+begin_src gnuplot :session none :results graphics :file "resources/images/babel-gnuplot-graphics-test.png" :exports "both"
set grid
...
[[file:resources/images/babel-gnuplot-graphics-test.png]]
