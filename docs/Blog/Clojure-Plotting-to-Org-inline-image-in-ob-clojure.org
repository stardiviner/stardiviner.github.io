...
#+begin_src org
,#+begin_src clojure :results value :var dir=(concat (file-name-directory (buffer-file-name)) "resources/images/")
(str dir "ob-clojure-literate.png")
,#+end_src

,#+RESULTS[<2018-05-17 01:12:55> 73be0ca9a40a4f1e4fdee8e535991955f77b034a]:
: "/home/stardiviner/Org/Wiki/Computer Technology/Programming/Emacs/Emacs Packages/Org mode/resources/images/ob-clojure-literate.png"
#+end_src
...
#+begin_src org
,#+HEADERS: :var cwd=(concat (file-name-directory (buffer-file-name)) "resources/images/")
...
#+header: :var cwd=(concat (file-name-directory (buffer-file-name)) "resources/images/")
#+begin_src clojure :results graphics file link :dir "images" :file "ob-clojure-literate.png"
(use '(incanter core stats datasets charts io pdf))
(def hist (histogram (sample-normal 1000)))
(save hist (str cwd "ob-clojure-literate.png"))
...
[[file:resources/images/ob-clojure-literate.png]]
...
#+begin_src org
,#+begin_src clojure :results graphics file link :dir "images" :file "ob-clojure-incanter-move.png" :var dir=(concat (file-name-directory (buffer-file-name)) "resources/images/")
(use '(incanter core stats datasets charts io pdf))
(import '(java.io File))
...
[[file:resources/images/ob-clojure-incanter-move.png]]
* Incanter
:PROPERTIES:
...
#+begin_src org
,#+begin_src clojure :results graphics :dir "images" :file "ob-clojure-literate.png" :var dir=(concat (file-name-directory (buffer-file-name)) "resources/images/")
(use '(incanter core stats datasets charts io pdf))
(def hist (histogram (sample-normal 1000)))
...
#+begin_src org
,#+begin_src clojure :results graphics file link :dir "images" :file "ob-clojure-clj-xchart.png" :var dir=(concat (file-name-directory (buffer-file-name)) "resources/images/")
...
#+begin_src clojure :eval no-export :results graphics file link :dir "images" :file "ob-clojure-clj-xchart.png" :var dir=(concat (file-name-directory (buffer-file-name)) "resources/images/")
(require '[com.hypirion.clj-xchart :as xchart])
...
[[file:resources/images/ob-clojure-clj-xchart.png]]
* ggplot2
:PROPERTIES:
